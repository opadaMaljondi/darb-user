          ...
          return Column(
            ...
            children: [
              if (bookingBloc.isMultiTypeVechiles &&
                ...
                Padding(
                  padding: (context.read<BookingBloc>().textDirection == 'ltr')
                      ? EdgeInsets.only(
                          left: size.width * 0.035, right: size.width * 0.04)
                      : EdgeInsets.only(
                          left: size.width * 0.04, right: size.width * 0.035),
                  child: Container(
                        ...
                        InkWell(
                          onTap: () {
                            ...
                            if (bookingBloc.showBiddingVehicles ||
                              ...
                              final baseBloc = context.read<BookingBloc>();
                              baseBloc.add(BookingEtaRequestEvent(
                                ...
                                preferenceId: baseBloc
                                        ...
                                        .isNotEmpty
                                    ? baseBloc.selectedPreferenceDetailsList
                                    : null,
                              ));
                            }
                          },
                          child: Container(
                            ...
                            // width: arg.transportType == 'taxi' ? size.width * 0.24 : size.width * 0.38,
                          ...
                          InkWell(
                            onTap: () {
                              if (!bookingBloc.showBiddingVehicles) {
                                ...
                                bookingBloc.checkNearByEta(
                                    bookingBloc.nearByDriversData, thisValue);
                                // If switching from Shared, refresh ETA without shared params to isolate Bidding list
