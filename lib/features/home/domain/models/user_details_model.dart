...
class UserDetail {
  ...
  String androidApp;
  String iosApp;
  String enableOutstationRoundTripFeature;
  ...
  UserDetail(
      ...
      required this.enableOutstationRoundTripFeature});
  ...
  factory UserDetail.fromJson(Map<String, dynamic> json) => UserDetail(
      ...
      wallet: json["wallet"] != null ? Wallet.fromJson(json["wallet"]) : Wallet(data: WalletData(id: '', userId: 0, amountAdded: 0.0, amountBalance: 0.0, amountSpent: 0.0, currencySymbol: '', currencyCode: '', createdAt: '', updatedAt: '')),
